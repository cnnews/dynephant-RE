...
Section "Dynephant 64-bit (GUI and CLI)"
  ...
  CreateShortCut "Update dynv6.net (64-bit).lnk" "$INSTDIR\dynephant.exe" "-6 -daemon=600 -host=cnnews.v6.rocks -token=randomtextforfoobarhere" "$INSTDIR\dynephant.exe" 0
SectionEnd
Section "Dynephant 32-bit (GUI and CLI)"
  ...
  CreateShortCut "Update dynv6.net (32-bit).lnk" "$INSTDIR\dynephant-x86.exe" "-6 -daemon=600 -host=cnnews.v6.rocks -token=randomtextforfoobarhere" "$INSTDIR\dynephant-x86.exe" 0
SectionEnd
